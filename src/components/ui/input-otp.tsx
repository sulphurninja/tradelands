...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex h-12 w-10 items-center justify-center rounded-lg border border-input bg-background text-base font-semibold shadow-xs transition-all outline-none sm:h-12 sm:w-11",
